...
-- The Sultans Ascend variant civilizations (4 civilizations — same DLC group)
INSERT INTO civilization (name, dlc, icon_path, enabled) SELECT 'Ayyubids',           'The Sultans Ascend', '/images/civs/ayyubids.png', TRUE WHERE NOT EXISTS (SELECT 1 FROM civilization WHERE name = 'Ayyubids');
INSERT INTO civilization (name, dlc, icon_path, enabled) SELECT 'Jeanne d''Arc',      'The Sultans Ascend', '/images/civs/jeanne-d-arc.png', TRUE WHERE NOT EXISTS (SELECT 1 FROM civilization WHERE name = 'Jeanne d''Arc');
INSERT INTO civilization (name, dlc, icon_path, enabled) SELECT 'Order of the Dragon', 'The Sultans Ascend', '/images/civs/order-of-the-dragon.png', TRUE WHERE NOT EXISTS (SELECT 1 FROM civilization WHERE name = 'Order of the Dragon');
INSERT INTO civilization (name, dlc, icon_path, enabled) SELECT 'Zhu Xi''s Legacy',   'The Sultans Ascend', '/images/civs/zhu-xis-legacy.png', TRUE WHERE NOT EXISTS (SELECT 1 FROM civilization WHERE name = 'Zhu Xi''s Legacy');
...
-- Migrate existing rows that were seeded with the old "Sultans Ascend Variant" label.
UPDATE civilization SET dlc = 'The Sultans Ascend' WHERE dlc = 'Sultans Ascend Variant';
